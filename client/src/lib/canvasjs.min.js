...
;(function () {
  ...
  function Ta(h, p, D) {
    if (h && p && D) {
      ...
      if ('undefined' !== typeof Blob && new Blob()) {
        for (
          var F = h.replace(/^data:[a-z\/]*;base64,/, ''),
            F = atob(F),
  ...
  function Oa(h, p, D) {
    if (r && bb) {
      ...
      h.height = D * W
      Ua !== Pa &&
        ((h.style.width = p + 'px'), (h.style.height = D + 'px'), u.scale(W, W))
  ...
  function ua(h, p, D) {
    p.getAttribute('state') ||
      ((p.style.backgroundColor = h.toolbar.backgroundColor),
    ...
    p.getAttribute('state') !== D &&
      ...
      (p.innerHTML =
        "<img sx='height:95%; pointer-events: none;' src='" +
        jb[D].image +
        "' alt='" +
        h._cultureInfo[D + 'Text'] +
        "' />"))
  }
  function Qa() {
  ...
  var $a = {},
    ...
    Ra = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((p = h.offsetX), (r = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((p = h.layerX), (r = h.layerY))
        : ((p = h.pageX - h.target.offsetLeft),
  ...
  V.prototype.setOptions = function (h, p) {
    if (ra[this._defaultsKey]) {
      ...
      for (u in r)
        'publicProperties' !== u &&
          r.hasOwnProperty(u) &&
          (this[u] = h && u in h ? h[u] : p && u in p ? p[u] : r[u])
  ...
  V.prototype.get = function (h) {
    ...
    if (
      p.hasOwnProperty(h) ||
      (p.publicProperties && p.publicProperties.hasOwnProperty(h))
    )
      return this[h]
    window.console &&
      window.console.log(
  ...
  V.prototype.set = function (h, p, r) {
    ...
    if ('options' === h) this.createUserOptions(p)
      ...
      u.hasOwnProperty(h) ||
      (u.publicProperties &&
        u.publicProperties.hasOwnProperty(h) &&
        'readWrite' === u.publicProperties[h])
    )
  ...
  V.prototype.updateOption = function (h) {
    ...
    this.themeOptions = r
    h in p &&
      (v = h in this.options ? this.options[h] : r && h in r ? r[h] : p[h])
  ...
  V.prototype.addEventListener = function (h, p, r) {
    h &&
      ...
      this._eventListeners[h].push({ context: r || this, eventHandler: p }))
  }
  ...
  Ga.prototype.registerSpace = function (h, p) {
    'top' === h
      ...
      : 'right' === h && (this._rightOccupied += p.width)
  }
  ...
  Na.Chart = (function () {
    ...
    function E(a, d, b, c, e, g, k, l, w, m) {
      ...
      a.beginPath()
      w && 0 < l.thickness
        ? (a.moveTo(c - k.thickness / 2, Math.round((b + e) / 2) - q),
          a.lineTo(d + k.thickness / 2, Math.round((b + e) / 2) - q))
        : 0 < l.thickness &&
          (a.moveTo(Math.round((d + c) / 2) - q, b + k.thickness / 2),
    ...
    p.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          var g = this.plotInfo.plotTypes[d], k = 0;
          k < g.plotUnits.length;
          k++
        ) {
          var l = g.plotUnits[k],
            w = null
    ...
    p.prototype.categoriseDataSeries = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          b = this.plotInfo.plotTypes[d], k = a = 0;
    ...
    p.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = 0;
              ...
              null === q.dataPoints[n].y
                ...
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e),
                  0 <= e
                    ? k[c]
                      ? (k[c] += e)
                      : ((k[c] = e), (w = Math.min(e, w)))
                    : l[c]
                    ? (l[c] += e)
                    : ((l[c] = e), (m = Math.max(e, m))))
            }
          }
          a.axisY.scaleBreaks &&
          ...
          if ('normal' === m.axisPlacement || 'xySwapped' === m.axisPlacement)
            var r = a.axisX.sessionVariables.newViewportMinimum
              ...
              t = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity
          if (
            (m.dataPoints[s].x && m.dataPoints[s].x.getTime) ||
            'dateTime' === m.xValueType
          )
            l = !0
          for (s = 0; s < m.dataPoints.length; s++) {
            'undefined' === typeof m.dataPoints[s].x &&
              (m.dataPoints[s].x = s + (a.axisX.logarithmic ? 1 : 0))
            m.dataPoints[s].x.getTime
              ? ((l = !0), (c = m.dataPoints[s].x.getTime()))
              : (c = m.dataPoints[s].x)
            ...
            if (!(c < r) || q) {
              ...
              m.dataPoints[s].label &&
                (a.axisX.labels[c] = m.dataPoints[s].label)
              c < b.viewPortMin && (b.viewPortMin = c)
              c > b.viewPortMax && (b.viewPortMax = c)
                  ...
                  if (
                    (c &&
                      ((q =
                        ...
                        100),
                      (g = h.dataPoints[w].x.getTime
                        ? h.dataPoints[w].x.getTime()
                        : h.dataPoints[w].x),
                      (q = Math.floor((g - m) / q)),
                      g < f[q].min && (f[q].min = g),
                      g > f[q].max && (f[q].max = g)),
                    ...
                    if (
                      (g =
                        'waterfall' === a.type
                          ? h.dataPointEOs[w].cumulativeSum
                          : h.dataPoints[w].y) &&
                      g.length
                    )
      ...
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(b && 1 < b.length)) {
          ...
          try {
            ...
            if (
              (1 < Math.abs(k) && this._lastTouchData.scroll) ||
              (5 < Math.abs(k) && 250 > g)
            )
          ...
          for (var g = 0; g < this.axisY.length; g++)
            b[c[e]].push({
              viewportMinimum: this[c[e]][g].sessionVariables
                .newViewportMinimum,
              viewportMaximum: this[c[e]][g].sessionVariables
                .newViewportMaximum,
            })
        else if ('axisY2' === c[e])
    ...
    p.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== x && '' !== x) {
          ...
          if ('stackedarea100' === s) {
            ...
            if (
              m.dataPoint.x < y.viewportMinimum ||
              m.dataPoint.x > y.viewportMaximum ||
              Math.max.apply(null, m.dataPoint.y) < A.viewportMinimum ||
              Math.min.apply(null, m.dataPoint.y) > A.viewportMaximum
            )
              continue
          } else if (
            0 <= s.indexOf('line') ||
            ...
            if (
              ...
              m.dataPoint.y > A.viewportMaximum
            )
              continue
          } else if (
            0 <= s.indexOf('column') ||
            'waterfall' === s ||
            ('error' === s && !m.axisSwapped)
          ) {
            if (
              m.dataPoint.x < y.viewportMinimum ||
              m.dataPoint.x > y.viewportMaximum ||
              ...
              : ((e = Math.max(m.bounds.y1, b.y1)),
                ...
                (c =
                  0 <= s.indexOf('range') || 'error' === s
                    ? 0 < ma
                      ? Math.max(m.bounds.y1, b.y1) + w / 2 + k
                      : Math.min(m.bounds.y2, b.y2) - w / 2 - k
                    : (Math.max(m.bounds.y1, b.y1) +
                        Math.min(m.bounds.y2, b.y2)) /
                      2),
                0 < ma
                  ? ((n = Math.max(m.point.y, c) - w / 2),
                    n < e &&
                      ('bubble' === s || 'scatter' === s) &&
                      (n = Math.max(m.point.y - w - k, b.y1 + k)))
                  : ((n = Math.min(m.point.y, c) - w / 2),
                    n > g - w - k &&
                      ('bubble' === s || 'scatter' === s) &&
                      (n = Math.min(m.point.y + k, b.y2 - w - k))),
                (n = Math.min(n, g - w)))
          } else
            0 <= s.indexOf('line') ||
            0 <= s.indexOf('area') ||
                ...
                : ((k = Math.max(m.bounds.x1, b.x1)),
                  ...
                  (c =
                    0 <= s.indexOf('range') || 'error' === s
                      ...
                      : (Math.max(m.bounds.x1, b.x1) +
                          Math.min(m.bounds.x2, b.x2)) /
                        2),
                  (q =
                    0 > ma
                      ? Math.max(m.point.x, c) - l / 2
                      : Math.min(m.point.x, c) - l / 2),
                  (q = Math.max(q, k)))
          'vertical' === C && (n += w)
          f.x = q
          f.y = n
          ...
          p &&
            ...
            0 <= s.indexOf('bar') || ('error' === s && m.axisSwapped)
              ...
              : d.lineTo(
                  q + l / 2,
                  n +
                    ((n < m.point.y ? w : -w) + ('horizontal' === C ? w : -w)) /
                      2
                ),
            d.stroke())
        }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]),
          (f = na('indexLabelBackgroundColor', m.dataPoint, m.dataSeries)),
          (m.dataSeries.indexLabelBackgroundColor = u(f)
            ? r
              ? 'transparent'
              : null
            : f)
    ...
    p.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var B = m._colorSet,
            h = (B = m.lineColor = m.options.lineColor
              ? m.options.lineColor
              : B[0])
          b.strokeStyle = B
          var p = !0,
            ...
            for (var u = !1, t = 0; t < s.length; t++)
              if (
                ...
                if ('number' !== typeof s[t].y)
                  ...
                  t < s.length - 1 &&
                    (h !== (s[t].lineColor || B) ||
                      q !== (s[t].lineDashType || m.lineDashType)) &&
                    (b.stroke(),
                    b.beginPath(),
                    b.moveTo(C, x),
                    (h = s[t].lineColor || B),
                    ...
                    b.setLineDash &&
                      (s[t].lineDashType
                        ? ((q = s[t].lineDashType),
                          b.setLineDash(R(q, m.lineThickness)))
            ...
            for (u = !1, p = 0; p < s.length; p++)
              if (
                ...
                if ('number' !== typeof s[p].y)
                  ...
                  p < s.length - 1 &&
                    (h !== (s[p].lineColor || B) ||
                      q !== (s[p].lineDashType || m.lineDashType)) &&
                    ((h = s[p].lineColor || B),
            ...
            for (m = 0; m < t.length; m++)
              if (
                ...
                if (
                  ...
                  ((q = a.axisY.convertValueToPixel(t[m].y)), 0 <= t[m].y)
                ) {
                ...
                c = t[m].color
                  ? t[m].color
                  : p._colorSet[m % p._colorSet.length]
                ea(
                  b,
                  x,
                  q,
    ...
    p.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < t.length)
            for (
              var u = 5 < f && h.bevelEnabled ? !0 : !1, m = 0;
              m < t.length;
              m++
            )
              if (
                ...
                c = t[m].color
                  ? t[m].color
                  : h._colorSet[m % h._colorSet.length]
                ea(
                  b,
                  x,
                  q,
            ...
            for (m = 0; m < t.length; m++)
              if (
                ...
                if (
                  ...
                  ((s = a.axisY.convertValueToPixel(t[m].y)), 0 <= t[m].y)
                ) {
                  var A = g[c] ? g[c] : 0
                  y = n + A
                  s += A
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < p.length) {
            ...
            for (var da = !0; h < p.length; h++)
              if (
                ((x = p[h].x.getTime ? p[h].x.getTime() : p[h].x),
                !(
                ...
                if ('number' !== typeof p[h].y)
                  ...
                  h < p.length - 1 &&
                    (T !== (p[h].lineColor || aa) ||
                      b !== (p[h].lineDashType || B.lineDashType)) &&
                    (c(),
                    (T = p[h].lineColor || aa),
                    (g.strokeStyle = T),
                    g.setLineDash &&
                  ...
                  0 !== p[h].markerSize &&
                    ...
                    ((x = B.getMarkerProperties(h, t, u, g)),
                    m.push(x),
                    (Z = N(Z)),
                    r &&
                      m.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < h.length) {
            ...
            for (; p < h.length; p++)
              if (
                ((x = h[p].x.getTime ? h[p].x.getTime() : h[p].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!B.connectNullData || !b))
                ...
                'number' !== typeof h[p].y
                  ...
                  : ((t = a.axisX.convertValueToPixel(x)),
                    ...
                    p < h.length - 1 &&
                      (T !== (h[p].lineColor || aa) ||
                        Y !== (h[p].lineDashType || B.lineDashType)) &&
                      (c(),
                      (T = h[p].lineColor || aa),
                      (g.strokeStyle = T),
                      g.setLineDash &&
              ...
              if (
                ...
                if ('number' !== typeof Z.y)
                  ...
                  0 <= A.dataPointIndexes[g] &&
                    0 !== Z.markerSize &&
                    (0 < Z.markerSize || 0 < A.markerSize) &&
                    ((la = A.getMarkerProperties(n, f, h, c)),
                    l.push(la),
                    (g = N(G)),
                    r &&
                      l.push({
    ...
    p.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < C.length)
            for (
              var x = 5 < h && t.bevelEnabled ? !0 : !1, l = 0;
              l < C.length;
              l++
            )
              if (
    ...
    p.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < x.length)
            for (
              var z = 5 < h && C.bevelEnabled ? !0 : !1, k = 0;
              k < x.length;
              k++
            )
              if (
                ...
                var y = (l - h / 2) << 0,
                  ...
                  T = x[k].whiskerColor
                    ...
                    : e,
                  Y =
                    'number' === typeof x[k].whiskerThickness
                      ? x[k].whiskerThickness
                      : 'number' === typeof C.options.whiskerThickness
                      ? C.whiskerThickness
                      : D,
                  ca = x[k].whiskerDashType
                    ? x[k].whiskerDashType
                    : C.whiskerDashType,
                  ...
                  oa = x[k].stemColor
                    ...
                    : e,
                  la =
                    'number' === typeof x[k].stemThickness
                      ? x[k].stemThickness
                  ...
                  E = x[k].lineColor
                    ...
                    : e,
                  H =
                    'number' === typeof x[k].lineThickness
                      ? x[k].lineThickness
                ...
                b.rect(
                  ...
                  Math.min(m, s) - aa,
                  A - y + 2 * aa,
                  Math.max(m, s) - Math.min(m, s) + 2 * aa
                )
                b.stroke()
                b.save()
                0 < H &&
    ...
    p.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < f.length)
            for (
              var h = 5 < m && n.bevelEnabled ? !0 : !1, g = 0;
              g < f.length;
              g++
            )
              if (
            ...
            for (g = 0; g < h.length; g++)
              if (
                ...
                !(
                  ...
                  !u(h[g].y) &&
                  h[g].y.length &&
                  'number' === typeof h[g].y[0] &&
                  'number' === typeof h[g].y[1])
              ) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < h.length) {
            ...
            for (f = !1; q < h.length; q++)
              if (
                ((n = h[q].x.getTime ? h[q].x.getTime() : h[q].x),
                !(
                ...
                if (
                  null !== h[q].y &&
                  h[q].y.length &&
                  'number' === typeof h[q].y[0] &&
                  'number' === typeof h[q].y[1]
                ) {
                  ...
                  q < h.length - 1 &&
                    (x !== (h[q].lineColor || C) ||
                      F !== (h[q].lineDashType || m.lineDashType)) &&
                    ((x = h[q].lineColor || C),
                  ...
                  if (
                    0 !== h[q].markerSize &&
                    (0 < h[q].markerSize || 0 < m.markerSize)
                  ) {
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[k].getTime ? (s = v[k].x.getTime()) : (s = v[k].x),
                'number' !== typeof v[k].y)
              ) {
                if (0 < k && !z && u.connectNullData)
                  var D =
                    u.options.nullDataLineDashType || !v[k - 1].lineDashType
                ...
                h =
                  0 === u.dataPointEOs[k].cumulativeSum
                    ? q
                    : a.axisY.convertValueToPixel(
                        u.dataPointEOs[k].cumulativeSum
                      )
                m =
                  0 === u.dataPointEOs[k].cumulativeSumYStartValue
                    ? q
                    : a.axisY.convertValueToPixel(
                        u.dataPointEOs[k].cumulativeSumYStartValue
                      )
                l = a.axisX.reversed
                  ? (l +
                ...
                var Y,
                  T = l
                Y =
                  ('undefined' !== typeof v[k].isIntermediateSum &&
                    !0 === v[k].isIntermediateSum) ||
                  ('undefined' !== typeof v[k].isCumulativeSum &&
    ...
    p.prototype.renderPie = function (a) {
      function d() {
        if (m && s) {
          for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
            ...
            k.indexLabelLineThickness = u(g.indexLabelLineThickness)
            ...
            k.indexLabelFontSize = u(g.indexLabelFontSize)
              ? m.indexLabelFontSize
              : g.indexLabelFontSize
            k.indexLabelFontFamily = g.indexLabelFontFamily
              ? g.indexLabelFontFamily
              : m.indexLabelFontFamily
            k.indexLabelBackgroundColor = g.indexLabelBackgroundColor
              ? g.indexLabelBackgroundColor
              : m.options.indexLabelBackgroundColor
              ? m.options.indexLabelBackgroundColor
              : m.indexLabelBackgroundColor
            k.indexLabelMaxWidth = g.indexLabelMaxWidth
            ...
            k.indexLabelTextBlock = new ka(h.plotArea.ctx, {
              ...
              maxHeight: k.indexLabelWrap
                ? 5 * k.indexLabelFontSize
                : 1.5 * k.indexLabelFontSize,
          ...
          for (d = 0; d < s.length; d++)
            (k = f[(c + d) % s.length]),
              1 < a &&
                k.midAngle > Math.PI / 2 - t &&
                k.midAngle < Math.PI / 2 + t &&
                (g <= a / 2 && !q
                  ? ((k.hemisphere = 'right'), g++)
                  : ((k.hemisphere = 'left'), (q = !0)))
          q = !1
          for (d = 0; d < s.length; d++)
            (k = f[(e + d) % s.length]),
              1 < b &&
        ...
        for (b = 0; b < s.length; b++) {
          ...
          if (e > c) {
            ...
            ja(
              ...
              f[b].center,
              f[b].radius,
              s[b].color ? s[b].color : m._colorSet[b % m._colorSet.length],
              m.type,
              c,
              e,
              m.fillOpacity,
      ...
      function l() {
        ...
        h.title &&
          (h.title.dockInsidePlotArea ||
            ('center' === h.title.horizontalAlign &&
              'center' === h.title.verticalAlign)) &&
          h.title.render()
        if (h.subtitles)
        ...
        h.legend &&
          (h.legend.dockInsidePlotArea ||
            ('center' === h.legend.horizontalAlign &&
              'center' === h.legend.verticalAlign)) &&
          (h.legend.setLayout(), h.legend.render())
      }
      var h = this
      if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              for (b = 0; b < s.length; b++) {
                ...
                var g = s[b].color
                  ? s[b].color
                  : m._colorSet[b % m._colorSet.length]
                e > c &&
                  ja(
                    h.plotArea.ctx,
                    f[b].center,
    ...
    p.prototype.renderFunnel = function (a) {
      ...
      function b() {
        ...
        if (0 === g) return -1
        for (
          var m = (e[0] = 0), k = 0, n, h, b = b - a, m = !1, l = 0;
          l < C.length;
          l++
        )
        ...
        if (d)
          for (k = J.length - 1; 0 <= k; k--)
            (a = P[k]),
              ...
              (J[k].textBlock.x = L - l),
              (c =
                J[k].textBlock.height < J[k].textBlock.maxHeight
                  ? J[k].textBlock.height
                  : J[k].textBlock.maxHeight),
              (d =
                J[k].textBlock.width < J[k].textBlock.maxWidth
                  ? J[k].textBlock.width
                  : J[k].textBlock.maxWidth),
              (J[k].height = c),
              (J[k].width = d),
              (c =
              ...
              t.reversed
                ? (J[k].textBlock.y + J[k].height > pa + D &&
                    (J[k].textBlock.y = pa + D - J[k].height),
                  J[k].textBlock.y < wa - D && (J[k].textBlock.y = wa - D))
                : (J[k].textBlock.y < pa - D && (J[k].textBlock.y = pa - D),
                  J[k].textBlock.y + J[k].height > wa + D &&
                    (J[k].textBlock.y = wa + D - J[k].height))
      }
      function g() {
        var a, b, c, e
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== C.length) {
          ...
          if (-1 !== I) {
            ...
            !z.animationEnabled && I
              ? h(z, -1, 0)
              : z.animationEnabled && !z.animatedRender && h(z, -1, 0)
    ...
    p.prototype.print = function () {
      ...
      c.document.open()
      c.document.write(
        '<!DOCTYPE HTML>\n<html><body sx="margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px;"><img src="' +
          a +
          '"/><body/></html>'
      )
      c.document.close()
    ...
    H.prototype.setLayout = function () {
      ...
      if (0 < h.length) {
        ...
        this.itemWidth = p
        this.height =
          !1 === this.itemWrap ? m.length * this.lineHeight : this.height + f
              ...
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (z =
                    ...
                    (m.textBlock.height - l.textBlock.fontSize / 2) *
              ...
              a[f] &&
                ...
                a[f]._labels &&
                  ...
                  (E = a[f].logarithmic
                    ...
                    : (0 < k
                        ? k * Math.abs(a[f].conversionParameters.pixelPerUnit)
                        : 0) + a[f].lineCoordinates.x1)))
          if (d && 0 < d.length)
            for (f = 0; f < d.length; f++)
              d[f].calculateValueToPixelConversionParameters(),
                ...
                d[f]._labels &&
                  ...
                  (E = d[f].logarithmic
                    ...
                    : (0 < k
                        ? k * Math.abs(d[f].conversionParameters.pixelPerUnit)
                        : 0) + d[f].lineCoordinates.x1))
          for (f = 0; f < n.length; f++)
            'axisY' === n[f].type &&
                  ...
                  b[K] &&
                    ...
                    ((h =
                      0 > b[K].labelAngle
                        ...
                        : h),
                    (k =
                      0 > b[K].labelAngle || 0 === b[K].labelAngle ? h - U : k))
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((h = c[K].lineCoordinates.x1), (k = h - U))
              a[f].lineCoordinates = {
                x1: h - O,
                y1: l,
                x2: h - O,
                  ...
                  b[K] &&
                    ...
                    ((h =
                      0 > b[K].labelAngle
                        ...
                        : h),
                    (k =
                      0 > b[K].labelAngle || 0 === b[K].labelAngle ? h - V : k))
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
                    ((h = c[K].lineCoordinates.x2), (k = h - V))
              d[f].lineCoordinates = {
                x1: h + Q,
                y1: l,
                x2: h + Q,
          ...
          if (
            ...
            for (
              var b = [],
                ...
                h = this.lineCoordinates.width / Math.log(this.range),
          ...
          if (
            ...
            for (
              var b = [],
                p,
                l = this.viewportMaximum,
                h = this.lineCoordinates.height / Math.log(this.range),
                m = this._labels.length - 1;
              0 <= m;
              m--
            ) {
    ...
    z.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      k = Math.pow(
        this.logarithmBase,
        z.getNiceNumber(Math.abs(Math.log(k) / d), !1)
      )
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = z.getNiceExponent(Math.log(k) / d / (a - 1), !0)),
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - d / 2, y1: k, x2: g + d / 2, y2: l })
        else if (
          ...
          (k = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            ...
            (this.bounds = { x1: e, y1: k - d / 2, x2: g, y2: l + d / 2 })
        this.ctx.moveTo(e, k)
        this.ctx.lineTo(g, l)
        this.ctx.stroke()
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            for (
              var f = Math.abs(
                  a - this.parent.convertValueToPixel(k[r].dataPoint.y[0])
                ),
                v = 0,
                n = 0;
              n < k.length;
              ...
              if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                for (h = 0; h < k[n].dataPoint.y.length; h++)
                  (v = Math.abs(
                    a - this.parent.convertValueToPixel(k[n].dataPoint.y[h])
                  )),
                    v < f && ((f = v), (r = n))
              else
                (v = Math.abs(
                  a - this.parent.convertValueToPixel(k[n].dataPoint.y)
                )),
                  v < f && ((f = v), (r = n))
            ...
            for (
              ...
              if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                ...
                (D += k[n].dataPoint.y),
                  (t = k[n].dataPoint.x.getTime
                    ? k[n].dataPoint.x.getTime()
                    : k[n].dataPoint.x),
          ...
          if (
            ...
            if (
              ...
              f = Math.abs(
                a - this.parent.convertValueToPixel(h.dataPoint.y[0])
              )
              for (n = v = 0; n < h.dataPoint.y.length; n++)
                (v = Math.abs(
                  a - this.parent.convertValueToPixel(h.dataPoint.y[n])
                )),
                  v < f && ((f = v), (b = n))
              k =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(h.dataPoint.y[b]) << 0) +
                    0.5
                  : this.parent.convertValueToPixel(h.dataPoint.y[b]) << 0
              ...
              (k =
                1 === p.lineWidth % 2
                  ? (this.parent.convertValueToPixel(h.dataPoint.y) << 0) + 0.5
                  : this.parent.convertValueToPixel(h.dataPoint.y) << 0),
                (l.text = this.labelFormatter
                  ? this.labelFormatter({
                      chart: this.chart,
                      axis: this.parent.options,
            ...
            e = g = k =
              1 === p.lineWidth % 2
                ? (this.parent.convertValueToPixel(h.dataPoint.x) << 0) + 0.5
                : this.parent.convertValueToPixel(h.dataPoint.x) << 0
            ...
            if (this.parent.labels)
              for (
                k = Math.ceil(this.parent.interval), n = 0;
          ...
          if (
            ...
            for (
              f = Math.abs(
                d - this.parent.convertValueToPixel(k[0].dataPoint.y[0])
              ),
                n = v = 0;
              n < k.length;
              n++
              ...
              if (k[n].dataPoint.y && k[n].dataPoint.y.length)
                for (h = 0; h < k[n].dataPoint.y.length; h++)
                  (v = Math.abs(
                    d - this.parent.convertValueToPixel(k[n].dataPoint.y[h])
                  )),
                    v < f && ((f = v), (r = n))
              else
                (v = Math.abs(
                  d - this.parent.convertValueToPixel(k[n].dataPoint.y)
                )),
                  v < f && ((f = v), (r = n))
          else if (
            ...
            for (
              f = Math.abs(
                d - this.parent.convertValueToPixel(k[0].dataPoint.y)
              ),
                n = D = v = 0;
              n < k.length;
              n++
          ...
          if (
            ...
            for (n = v = 0; n < h.dataPoint.y.length; n++)
              (v = Math.abs(
                d - this.parent.convertValueToPixel(h.dataPoint.y[n])
              )),
                v < f && ((f = v), (b = n))
            k =
              1 === p.lineWidth % 2
                ? (this.parent.convertValueToPixel(h.dataPoint.y[b]) << 0) + 0.5
                : this.parent.convertValueToPixel(h.dataPoint.y[b]) << 0
            l.text = this.labelFormatter
              ? this.labelFormatter({
                  chart: this.chart,
              ...
              ? ((k =
                  1 === p.lineWidth % 2
                    ? (this.parent.convertValueToPixel(
                        h.dataSeries.dataPointEOs[h.index].cumulativeSum
                      ) <<
                        0) +
                      0.5
                    : this.parent.convertValueToPixel(
    ...
    $.prototype._initialize = function () {
      if (this.enabled) {
        ...
        var a
        a = '<div sx=" width: auto;height: auto;min-width: 50px;'
        a += 'line-height: auto;'
        ...
        if (
          ...
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var h = 0; h < this.chart.axisX.length; h++) {
                for (
                  var k = this.chart.axisX[h].convertPixelToValue({ y: d }),
                    m = null,
                    c = 0;
                  c < this.chart.axisX[h].dataSeries.length;
                  c++
                )
                  (m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(
                    k,
                    b
                  )) &&
                    0 <= m.index &&
                    ((m.dataSeries = this.chart.axisX[h].dataSeries[c]),
            ...
            if (this.chart.axisX2)
              for (h = 0; h < this.chart.axisX2.length; h++) {
                ...
                for (c = 0; c < this.chart.axisX2[h].dataSeries.length; c++)
                  (m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(
                    k,
                    b
                  )) &&
                    0 <= m.index &&
                    ((m.dataSeries = this.chart.axisX2[h].dataSeries[c]),
                    null !== m.dataPoint.y && l.push(m))
                m = null
              }
          } else {
            ...
            if (this.chart.axisX)
              for (h = 0; h < this.chart.axisX.length; h++)
                for (
                  k = this.chart.axisX[h].convertPixelToValue({ x: a }),
                    m = null,
                    c = 0;
                  c < this.chart.axisX[h].dataSeries.length;
                  c++
            ...
            if (this.chart.axisX2)
              for (h = 0; h < this.chart.axisX2.length; h++)
                for (
                  k = this.chart.axisX2[h].convertPixelToValue({ x: a }),
                    m = null,
                    c = 0;
                  c < this.chart.axisX2[h].dataSeries.length;
                  c++
                )
                  (m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(
                    k,
          ...
          if ((m = this.chart.getDataPointAtXY(a, d, b)))
            ...
            if (
              ...
              0 < m &&
                'undefined' !== typeof this.chart._eventManager.objectMap[m])
            ) {
              ...
              this.currentDataPointIndex =
                0 <= m.dataPointIndex ? m.dataPointIndex : -1
                ...
                if (0 < m.dataPoint.y.length) {
                  for (c = b = 0; c < m.dataPoint.y.length; c++)
                    m.dataPoint.y[c] < m.dataSeries.axisY.viewportMinimum
                      ? b--
                      : m.dataPoint.y[c] > m.dataSeries.axisY.viewportMaximum &&
                        b++
                  b < m.dataPoint.y.length &&
                    b > -m.dataPoint.y.length &&
                    g.push(m)
                } else
          ...
          if ((this.highlightObjects(g), this.enabled))
            if (
              ...
              'stackedBar100' === g[0].dataSeries.type
                ...
                : ((a =
                    (g[0].dataSeries.axisX.convertValueToPixel(
                      g[0].dataPoint.x
                    ) -
                      this.container.clientWidth) <<
                    0),
    ...
    $.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries
      for (
        var d = null, b = null, c = null, e = 0, g = '', k = !0, h = 0;
        h < a.length;
        h++
      )
  ...
  (function () {
    ...
    d.drawText_ = function (a, b, c, d, e) {
      ...
      n.push(
        ...
        '" stroked="',
        !!e,
        '" sx="position:absolute;width:1px;height:1px;">'
      )
    ...
    d.measureText = function (a) {
      this.textMeasureEl_ ||
        (this.element_.insertAdjacentHTML(
          'beforeEnd',
          '<span sx="position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;"></span>'
        ),
