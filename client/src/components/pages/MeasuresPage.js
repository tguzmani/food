...
const MeasurementsPage = () => {
  ...
  useConditionalRead({ name: readMeasurements, condition: measurements.length === 0 })
  ...
  return (
    <>
      <Grid container display='flex' spacing={3}>
        ...
        <Typography variant='h6' component='h2' gutterBottom>This block</Typography>

          <Measurements measurements={measurements} current />
        </Grid>

        <Grid item xs={12} lg={6}>
          <Typography variant='h6' component='h2' gutterBottom>Last block</Typography>
